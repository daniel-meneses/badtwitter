...
test("Should display empty text fields on initial render", () => {
    ...
    const [alias, email, pw1] = getAllByTestId('textfield')
...
test("Should display email invalid format error", () => {
    ...
    expect(getAllByTestId('textfield-error')[1]).toHaveTextContent('Invalid email format')
});
...
test("Should display email cannot be blank error", () => {
    ...
    fireEvent.blur(email)
    expect(getAllByTestId('textfield-error')[1]).toHaveTextContent('Email cannot be blank')
});
...
test("Should display email cannot start with a space error", () => {
    ...
    fireEvent.blur(email)
    expect(getAllByTestId('textfield-error')[1]).toHaveTextContent('Email cannot start with a space')
});
...
test("Should remove email error on change", () => {
    ...
    expect(getAllByTestId('textfield-error')[1]).toBeUndefined()
});
/*
...
test("Should display password must be 6 characters error", () => {
    ...
    fireEvent.blur(pw1)
    expect(getAllByTestId('textfield-error')[1]).toHaveTextContent('Password must be at least 6 characters')
});
