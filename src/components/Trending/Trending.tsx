...
const Trending = (props: any) => {
  ...
  const trendingHtml: React.FC<Trending> = ( {title, count}) => (
    <div className={trending_item} onClick={() => history.push('/explore/tags/' + title)}>
  ...
  return (
      <div  className={trendingContainer}>
        ...
        <div className={trending_title}>Trending</div>
          {
            trending.map( (t: Trending) => {
              return trendingHtml({...t})
            })
          }
